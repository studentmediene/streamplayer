...
function InlinePlayer() {
  ...
  this.handleClick = function(e) {
    ...
    var streamre = new RegExp(settings.stream + "$", "i");
    if (!o.href || (!o.href.match(/\.mp3(\\?.*)$/i) && !o.href.match(streamre)) || self.classContains(o,self.excludeClass)) {
      if (isIE && o.onclick) {
  ...
  this.init = function() {
    ...
    for (var i=0; i<oLinks.length; i++) {
      if (((oLinks[i].href.match(/\.mp3/i)) || (oLinks[i].href.match(/campus$/i))) && !self.classContains(oLinks[i],self.excludeClass)) {
...
soundManager.nullURL = document.URL + '/null.mp3';
