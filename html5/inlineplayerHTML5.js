...
function InlinePlayer() {
  ...
  this.handleClick = function(e) {
    ...
    if (!o.href || (!o.href.match(/\.mp3(\\?.*)$/i) && !o.href.match(/revolt$/i)) || self.classContains(o,self.excludeClass)) {
      if (isIE && o.onclick) {
  ...
  this.init = function() {
    ...
    for (var i=0; i<oLinks.length; i++) {
      if (((oLinks[i].href.match(/\.mp3/i)) || (oLinks[i].href.match(/revolt$/i))) && !self.classContains(oLinks[i],self.excludeClass)) {
